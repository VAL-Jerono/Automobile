...
\shorttitle{Gradient Boosting Framework for Insurance Customer Analytics}
\shortauthors{Jerono, V.}

% ============================================================================
% TITLE AND AUTHOR
% ============================================================================
\title[mode = title]{From Reactive to Predictive: An Integrated Gradient Boosting Framework for Customer Lifetime Value Optimization and Churn Prevention in Automobile Insurance Portfolios}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.45\textwidth]{visualizations/10_correlation_heatmap.png}
\caption{Correlation heatmap showing relationships among key portfolio variables. Strong multicollinearity between driver age and license years ($r = 0.89$) informs feature selection.}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.40\textwidth]{visualizations/01_portfolio_churn_distribution.png}
\caption{Portfolio churn distribution showing 20.4\% churn rate (21,548 of 105,555 policies).}
...
\caption{Customer lifecycle vulnerability curve showing lapse rates by tenure year. The ``valley of death'' during years 1--3 exhibits 26.5\% average lapse rate, 58\% above portfolio average (20.4\%) and 59\% higher than mature relationships exceeding 10 years.}
\label{fig:lifecycle}
\end{figure}
\FloatBarrier
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.65\textwidth]{ROI and Channel.png}
\caption{Distribution channel comparative economics. Agent channel demonstrates 2.5$\times$ higher ROI (752\% vs. 297\%), 60\% longer tenure, 14\% lower loss ratios, and 21\% reduced churn propensity. The \texteuro{}483 CLV gap persists despite broker customers paying 8.5\% higher premiums.}
\label{fig:channel}
\end{figure}
\FloatBarrier
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.60\textwidth]{visualizations/risk_01_vehicle_risk_profile.png}
\caption{Vehicle risk profile analysis showing claims frequency across vehicle types and geographic areas. Urban commercial vehicles exhibit systematically higher claims rates.}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.60\textwidth]{segment.png}
\caption{Customer segmentation matrix showing portfolio distribution and mean CLV by quadrant. PROTECT (34.6\%, \texteuro{}542), DEVELOP (30.8\%, \texteuro{}156), MANAGE (15.4\%, \texteuro{}387), EXIT (19.2\%, \texteuro{}89).}
\label{fig:segments}
\end{figure}
\FloatBarrier
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.45\textwidth]{visualizations/retention_01_churn_by_tenure.png}
\caption{Churn rate by tenure confirming the ``lifecycle valley of death'' in years 1--3.}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.45\textwidth]{visualizations/channel_01_performance_dashboard.png}
\caption{Channel performance: agent advantages persist across CLV, tenure, loss ratio, and churn.}
